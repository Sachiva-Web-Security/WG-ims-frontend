        ...
        <div className="relative space-y-6">
          ...
          <div className="flex flex-wrap gap-2">
            {['📊 Live gap tracking', '🚚 Supply dispatch', '📦 Multi locations', '🔐 Role-based access'].map(f => (
              <span key={f} className="text-xs bg-white/5 text-slate-400 border border-white/10 px-3 py-1.5 rounded-full">
                {f}
              </span>
            ))}
          </div>
        ...
        <div className="w-full max-w-md fade-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="name@wavagrill.com"
                value={form.email}
          ...
          <div className="mt-8 pt-6 border-t border-slate-200">
            ...
            <div className="grid grid-cols-2 gap-2">
              {DEMO.map(d => (
                <button key={d.email}
                  onClick={() => setF({ email: d.email, password: 'Password1!' })}
